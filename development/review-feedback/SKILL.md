...
description: Independent review of phase/workflow outputs. Inspects current-phase artifact together with all prior-phase artifacts (cumulative review). Tags issues by origin phase, severity, type. Recommends fix-in-place or roll-back. Use after any phase artifact is produced before the next step proceeds.
license: MIT
metadata:
  author: kenpusney
  version: "0.1.0"
...
Available: use reviewer subagent (read-only) to inspect artifacts and produce report. Producer handles fixes, reviewer re-checks.
