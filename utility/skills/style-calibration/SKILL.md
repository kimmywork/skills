...
Choose the smallest suitable format from `references/output-template.md`: compact profile, full profile, comparison, or application note. Adapt user-facing output to the user's language and never imply source-author authorship or endorsement. The result may support a style guide, rewrite, or later drafting work.
